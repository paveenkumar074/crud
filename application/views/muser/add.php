	...
	<div class="container">
		<div class="row">
			<div class="table-wrapper">
				...
				<div class="row">
					<?php echo form_open('muser/add',array("class"=>"form-horizontal","enctype"=>"multipart/form-data")); ?> 
					<div class="col-sm-6">
						...
						<div class="row col-sm-12">
							<div class="col-sm-6 form-group">
								...
								<div class="input-group date" id="datepicker">
									<input type="text" class="form-control" name="Birthday"  value="<?php echo $this->input->post('Birthday'); ?>"/>
							...
							<div class="row col-sm-6 ml-45">
								...
								<select name="CountryUID" class="form-control" required>
									...
									{
										$selected = ($mcountry['CountryUID'] == $this->input->post('CountryUID')) ? ' selected="selected"' : "";
							...
							<div class="col-sm-5">
								<div class="form-grousp">
									...
									<select name="TeamUID" class="form-control">
										...
										{
											$selected = ($mteam['TeamUID'] == $this->input->post('TeamUID')) ? ' selected="selected"' : "";
						...
						<div class="row">
							<div class="form-group col-sm-6">
								...
								<select name="CollegeUID" class="form-control">
									...
									{
										$selected = ($mcollege['CollegeUID'] == $this->input->post('CollegeUID')) ? ' selected="selected"' : "";
							...
							<div class="col-sm-6">
								...
								<input type="text" name="NBAdebut" value="<?php echo $this->input->post('NBAdebut'); ?>" class="form-control" id="NBAdebut" required />
